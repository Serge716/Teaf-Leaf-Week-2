...
# A board game with 2 players.  Start with an empty board with 9 (3 x 3) square
# One player is "X" and the other player is "O"
# Two Players alternate turns to mark empty squares, until a player gets 3 squares in a row
# If all squares are marked and nobody wins its a tie
